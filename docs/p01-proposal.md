...
The second chart was created to answer the question, “What is the relationship between sleep duration and fear of COVID-19 for university students for online learning during the pandemic?” There was no significant finding within this chart. The chart does show that as fear of COVID-19 increased, the average hours of sleep increased. This could be because students were staying at home to not get the virus, resulting in a greater opportunity to stay in and sleep. As well as that, with class online, there is even more room to catch up on sleep. Though, it is important to note that the data is extremely scattered with a significant number of outliers.
